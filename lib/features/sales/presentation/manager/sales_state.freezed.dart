...
mixin _$SalesState {
  ...
  List<ClientSupplierEntity> get clients; // بيانات العملية الحالية
  InvoiceType get invoiceType;
  InvoicePaymentType get paymentType;
  List<InvoiceItemEntity> get cartItems; // الحسابات المالية
  double get subTotal;
  double get discount;
  double get tax;
  double get totalAmount;
  double get paidAmount; // حالة التحكم
  String? get errorMessage;
  bool get isSuccess; // الفاتورة التي تم حفظها للتو (لغرض الطباعة)
  InvoiceEntity?
      get lastSavedInvoice; // [NEW] الفاتورة الأصلية (المرجعية) لعمليات المرتجع
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.lastSavedInvoice, lastSavedInvoice) ||
                other.lastSavedInvoice == lastSavedInvoice) &&
            (identical(other.originalInvoice, originalInvoice) ||
                other.originalInvoice == originalInvoice));
  }
...
abstract mixin class $SalesStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<ClientSupplierEntity> clients,
      InvoiceType invoiceType,
      InvoicePaymentType paymentType,
      List<InvoiceItemEntity> cartItems,
      double subTotal,
      double discount,
      double tax,
      double totalAmount,
...
class _$SalesStateCopyWithImpl<$Res> implements $SalesStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? lastSavedInvoice = freezed,
    Object? originalInvoice = freezed,
  }) {
    return _then(_self.copyWith(
      ...
      isSuccess: null == isSuccess
          ...
          : isSuccess // ignore: cast_nullable_to_non_nullable
              as bool,
      lastSavedInvoice: freezed == lastSavedInvoice
          ? _self.lastSavedInvoice
          : lastSavedInvoice // ignore: cast_nullable_to_non_nullable
              as InvoiceEntity?,
      originalInvoice: freezed == originalInvoice
          ? _self.originalInvoice
          : originalInvoice // ignore: cast_nullable_to_non_nullable
              as InvoiceEntity?,
    ));
  }
}
    ...
    switch (_that) {
      case _SalesState() when $default != null:
        return $default(
            ...
            _that.errorMessage,
            _that.isSuccess,
            _that.lastSavedInvoice,
            _that.originalInvoice);
      case _:
        return orElse();
    }
  }
...
class _SalesState implements SalesState {
  const _SalesState(
      ...
      final List<ClientSupplierEntity> clients = const [],
      this.invoiceType = InvoiceType.sales,
      this.paymentType = InvoicePaymentType.cash,
      final List<InvoiceItemEntity> cartItems = const [],
      this.subTotal = 0.0,
      this.discount = 0.0,
      this.tax = 0.0,
...
// البيانات المرجعية
  ...
  @override
  @JsonKey()
  List<ClientSupplierEntity> get clients {
...
// بيانات العملية الحالية
  ...
  @override
  @JsonKey()
  List<InvoiceItemEntity> get cartItems {
