...
mixin _$InvoicesListState {
  bool get isLoading;
  bool get isMoreLoading; // [NEW] تحميل المزيد
  ...
  $InvoicesListStateCopyWith<InvoicesListState> get copyWith =>
      _$InvoicesListStateCopyWithImpl<InvoicesListState>(
          this as InvoicesListState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is InvoicesListState &&
            ...
            const DeepCollectionEquality()
                .equals(other.allInvoices, allInvoices) &&
            const DeepCollectionEquality()
                .equals(other.searchResults, searchResults) &&
            const DeepCollectionEquality()
                .equals(other.filteredInvoices, filteredInvoices) &&
  ...
  int get hashCode => Object.hash(
      ...
      hasReachedMax,
      isSearching,
      const DeepCollectionEquality().hash(allInvoices),
      const DeepCollectionEquality().hash(searchResults),
      const DeepCollectionEquality().hash(filteredInvoices),
      filterType,
      searchQuery,
      errorMessage);
...
abstract mixin class $InvoicesListStateCopyWith<$Res> {
  factory $InvoicesListStateCopyWith(
          InvoicesListState value, $Res Function(InvoicesListState) _then) =
      _$InvoicesListStateCopyWithImpl;
  @useResult
  $Res call(
      {bool isLoading,
      bool isMoreLoading,
      ...
      List<InvoiceEntity> searchResults,
      List<InvoiceEntity> filteredInvoices,
      InvoiceType filterType,
      String searchQuery,
      String? errorMessage});
}
    ...
    return _then(_self.copyWith(
      ...
      searchResults: null == searchResults
          ...
          : searchResults // ignore: cast_nullable_to_non_nullable
              as List<InvoiceEntity>,
      filteredInvoices: null == filteredInvoices
          ? _self.filteredInvoices
          : filteredInvoices // ignore: cast_nullable_to_non_nullable
              as List<InvoiceEntity>,
...
extension InvoicesListStatePatterns on InvoicesListState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_InvoicesListState value)? $default, {
...
class _InvoicesListState implements InvoicesListState {
  const _InvoicesListState(
      ...
      final List<InvoiceEntity> allInvoices = const [],
      final List<InvoiceEntity> searchResults = const [],
      final List<InvoiceEntity> filteredInvoices = const [],
      this.filterType = InvoiceType.sales,
      this.searchQuery = '',
      this.errorMessage})
...
// [NEW] هل نحن في وضع البحث؟
  @override
  @JsonKey()
  List<InvoiceEntity> get allInvoices {
...
// القائمة المتراكمة (Pagination)
  @override
  @JsonKey()
  List<InvoiceEntity> get searchResults {
...
// نتائج البحث (Search)
  ...
  List<InvoiceEntity> get filteredInvoices {
    if (_filteredInvoices is EqualUnmodifiableListView)
...
// المعروض في الواجهة
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$InvoicesListStateCopyWith<_InvoicesListState> get copyWith =>
      __$InvoicesListStateCopyWithImpl<_InvoicesListState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _InvoicesListState &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
            (identical(other.isMoreLoading, isMoreLoading) ||
                other.isMoreLoading == isMoreLoading) &&
            ...
            const DeepCollectionEquality()
                .equals(other._filteredInvoices, _filteredInvoices) &&
            (identical(other.filterType, filterType) ||
                other.filterType == filterType) &&
            (identical(other.searchQuery, searchQuery) ||
                other.searchQuery == searchQuery) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_filteredInvoices),
      filterType,
      searchQuery,
      errorMessage);
...
/// @nodoc
abstract mixin class _$InvoicesListStateCopyWith<$Res>
    implements $InvoicesListStateCopyWith<$Res> {
  factory _$InvoicesListStateCopyWith(
          _InvoicesListState value, $Res Function(_InvoicesListState) _then) =
      __$InvoicesListStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isLoading,
