...
mixin _$InvoiceModel {
  ...
  String? get id;
  String get invoiceNumber; // --- حقول التصنيف والحالة (ERP) ---
  InvoiceType get type;
  InvoiceStatus get status; // طريقة الدفع (نقد / آجل)
  InvoicePaymentType
      get paymentType; // [NEW] رقم الفاتورة الأصلية (للمرتجعات فقط)
  String? get originalInvoiceNumber; // بيانات العميل
  String get clientId;
  String get clientName; // التواريخ
  @TimestampConverter()
  DateTime get date;
  @TimestampConverter()
  DateTime? get dueDate; // العناصر
  List<InvoiceItemModel> get items; // الحسابات المالية
  double get subTotal;
  double get discount;
  double get tax;
  double get totalAmount; // المدفوعات والملاحظات
