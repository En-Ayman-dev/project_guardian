...
mixin _$InvoiceItemModel {
 ...
 String get productId; String get productName; String get unitId; String get unitName; double get conversionFactor; int get quantity; double get price; double get total;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,productId,productName,unitId,unitName,conversionFactor,quantity,price,total);
...
@useResult
$Res call({
 String productId, String productName, String unitId, String unitName, double conversionFactor, int quantity, double price, double total
});
...
/// Create a copy of InvoiceItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? productId = null,Object? productName = null,Object? unitId = null,Object? unitName = null,Object? conversionFactor = null,Object? quantity = null,Object? price = null,Object? total = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String productId,  String productName,  String unitId,  String unitName,  double conversionFactor,  int quantity,  double price,  double total)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InvoiceItemModel() when $default != null:
return $default(_that.productId,_that.productName,_that.unitId,_that.unitName,_that.conversionFactor,_that.quantity,_that.price,_that.total);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String productId,  String productName,  String unitId,  String unitName,  double conversionFactor,  int quantity,  double price,  double total)  $default,) {final _that = this;
switch (_that) {
case _InvoiceItemModel():
return $default(_that.productId,_that.productName,_that.unitId,_that.unitName,_that.conversionFactor,_that.quantity,_that.price,_that.total);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String productId,  String productName,  String unitId,  String unitName,  double conversionFactor,  int quantity,  double price,  double total)?  $default,) {final _that = this;
switch (_that) {
case _InvoiceItemModel() when $default != null:
return $default(_that.productId,_that.productName,_that.unitId,_that.unitName,_that.conversionFactor,_that.quantity,_that.price,_that.total);case _:
  return null;
...
class _InvoiceItemModel extends InvoiceItemModel {
  const _InvoiceItemModel({required this.productId, required this.productName, required this.unitId, required this.unitName, required this.conversionFactor, required this.quantity, required this.price, required this.total}): super._();
...
/// Create a copy of InvoiceItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? productId = null,Object? productName = null,Object? unitId = null,Object? unitName = null,Object? conversionFactor = null,Object? quantity = null,Object? price = null,Object? total = null,}) {
