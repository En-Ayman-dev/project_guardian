...
mixin _$ProductModel {
  ...
  String? get id;
  String get name;
  String? get description; // --- التعديل 1: إضافة حقل الباركود ---
  String? get barcode;
  String get categoryId;
  String get categoryName; // القائمة الجديدة
  List<ProductUnitModel> get units;
  double get stock;
    ...
    return _then(_self.copyWith(
      ...
      units: null == units
          ...
          : units // ignore: cast_nullable_to_non_nullable
              as List<ProductUnitModel>,
      stock: null == stock
          ? _self.stock
          : stock // ignore: cast_nullable_to_non_nullable
              as double,
      minStockAlert: null == minStockAlert
          ? _self.minStockAlert
...
class _ProductModel extends ProductModel {
  const _ProductModel(
      ...
      required final List<ProductUnitModel> units,
      this.stock = 0.0,
