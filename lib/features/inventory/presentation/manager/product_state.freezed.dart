...
extension ProductStatePatterns on ProductState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isLoading, List<ProductEntity> products,
            String? errorMessage, bool isActionSuccess)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ProductState() when $default != null:
        return $default(_that.isLoading, _that.products, _that.errorMessage,
            _that.isActionSuccess);
      case _:
        return orElse();
    }
  }
