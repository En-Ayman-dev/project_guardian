...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _AuthCheckRequested value)?  authCheckRequested,TResult Function( _SignedOut value)?  signedOut,TResult Function( _UserChanged value)?  userChanged,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AuthCheckRequested() when authCheckRequested != null:
return authCheckRequested(_that);case _SignedOut() when signedOut != null:
return signedOut(_that);case _UserChanged() when userChanged != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _AuthCheckRequested value)  authCheckRequested,required TResult Function( _SignedOut value)  signedOut,required TResult Function( _UserChanged value)  userChanged,}){
final _that = this;
switch (_that) {
case _AuthCheckRequested():
return authCheckRequested(_that);case _SignedOut():
return signedOut(_that);case _UserChanged():
return userChanged(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _AuthCheckRequested value)?  authCheckRequested,TResult? Function( _SignedOut value)?  signedOut,TResult? Function( _UserChanged value)?  userChanged,}){
final _that = this;
switch (_that) {
case _AuthCheckRequested() when authCheckRequested != null:
return authCheckRequested(_that);case _SignedOut() when signedOut != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  authCheckRequested,TResult Function()?  signedOut,TResult Function( UserEntity? user)?  userChanged,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthCheckRequested() when authCheckRequested != null:
return authCheckRequested();case _SignedOut() when signedOut != null:
return signedOut();case _UserChanged() when userChanged != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  authCheckRequested,required TResult Function()  signedOut,required TResult Function( UserEntity? user)  userChanged,}) {final _that = this;
switch (_that) {
case _AuthCheckRequested():
return authCheckRequested();case _SignedOut():
return signedOut();case _UserChanged():
return userChanged(_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  authCheckRequested,TResult? Function()?  signedOut,TResult? Function( UserEntity? user)?  userChanged,}) {final _that = this;
switch (_that) {
case _AuthCheckRequested() when authCheckRequested != null:
return authCheckRequested();case _SignedOut() when signedOut != null:
return signedOut();case _UserChanged() when userChanged != null:
