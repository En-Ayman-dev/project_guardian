...
mixin _$LoginState {
  ...
  int get hashCode => Object.hash(
      runtimeType, isLoading, isSuccess, errorMessage, isPasswordObscured);
...
extension LoginStatePatterns on LoginState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isLoading, bool isSuccess, String? errorMessage,
            bool isPasswordObscured)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _LoginState() when $default != null:
        return $default(_that.isLoading, _that.isSuccess, _that.errorMessage,
            _that.isPasswordObscured);
      case _:
        return orElse();
    }
  }
