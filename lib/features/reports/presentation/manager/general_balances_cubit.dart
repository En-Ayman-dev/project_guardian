...
class GeneralBalancesCubit extends Cubit<GeneralBalancesState> {
  ...
  GeneralBalancesCubit(this._getBalances, this._pdfService)
    : super(const GeneralBalancesState.initial());
  ...
  Future<void> loadBalances() async {
    ...
    result.fold((failure) => emit(GeneralBalancesState.error(failure.message)), (
      entities,
    ) {
      // حساب الإجماليات
      // افتراض:
